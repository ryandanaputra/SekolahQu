...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#modalTambahSiswa">Tambah Data</button>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="hapus_siswa.php?nis=<?php echo $row['nis']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
