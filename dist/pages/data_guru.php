...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#modalTambahGuru">Tambah Data</button>
                    ...
                    <table class="table table-bordered">
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_guru.php?nip=<?php echo $row['nip']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="hapus_guru.php?nip=<?php echo $row['nip']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="id_mapel" required>
                            ...
                            <?php
                            include 'koneksi.php';
                            $query = "SELECT id_mapel, nama_mapel FROM mapel";
                            $result = mysqli_query($conn, $query);
